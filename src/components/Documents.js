...
import { Upload, FileText, Folder, Search, Filter, Eye, Download, Trash2, FileSpreadsheet } from 'lucide-react';
import { CSVMigration } from './CSVMigration';
...
export const Documents = ({
  ...
  const [showCSVMigration, setShowCSVMigration] = useState(false);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-3">
          <button
            onClick={() => setShowCSVMigration(true)}
      ...
      {showCSVMigration && (
        <CSVMigration
          onClose={() => setShowCSVMigration(false)}
